...
class roleHandler(commands.Cog):
    ...
    async def sortBySpreadsheet(self, ctx,
        ...
        if confirm:
            ...
            recievedData = helper.getSpreadSheetData(r"C:\Users\trexx\Documents\PYTHON CODE LOL\CODEBOZU\bozuBot\credentials.json", spreadSheetName)
                ...
                if location != "" and level != "" and m1 != "":
                    ...
                    for memberUsername in [m1,m2,m3,m4]:
                        if memberUsername != "":
                            ...
                            if not memberObj:
                                continue
                            memberObj.add_roles(createdRole)
