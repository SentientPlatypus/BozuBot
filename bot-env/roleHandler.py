    ...
    async def sortBySpreadsheet(self, ctx,
        ...
        if confirm:
            ...
            for row in recievedData:
                ...
                m1:nextcord.Member = ctx.guild.get_member_named(row[member1ColHead]) if row[member1ColHead] != "" else None
                m2:nextcord.Member = ctx.guild.get_member_named(row[member2ColHead]) if row[member2ColHead] != "" else None
                m3:nextcord.Member = ctx.guild.get_member_named(row[member3ColHead]) if row[member3ColHead] != "" else None
                m4:nextcord.Member = ctx.guild.get_member_named(row[member4ColHead]) if row[member4ColHead] != "" else None
                m5:nextcord.Member = ctx.guild.get_member_named(row[member5ColHead]) if row[member5ColHead] != "" else None
